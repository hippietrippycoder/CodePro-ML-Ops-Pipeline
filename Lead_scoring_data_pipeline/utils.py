...
from Lead_scoring_data_pipeline.dags.schema import *
...
def load_data_into_db():
    ...
    df_lead_scoring = pd.read_csv(LOAD_DATA_DIRECTORY+'leadscoring.csv')
...
def raw_data_schema_check():
    ...
    loaded_data= pd.read_csv(LOAD_DATA_DIRECTORY+'leadscoring.csv')
